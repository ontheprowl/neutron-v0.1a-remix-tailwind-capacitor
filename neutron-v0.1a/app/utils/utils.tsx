...
import type { ChatEvent, ContractEvent, NeutronEvent, PaymentEvent } from "~/models/events";
...
/**
 * This functions validates an email ID
 * @param {string} email - The email to test for validity
 * @returns {boolean} true for valid emails, false otherwise
 */
...
/**
 * Utility function that translates DisputeType into appropriate text
 * @param type DisputeType
 * @returns 
 */
...
/**
 * Utility function that checks if any JavaScript Object is empty 
...
/**
 * Utility function to format a date specified in milliseconds to a readable date
 * @param {string | number} milliseconds The date to be formatted, represented in milliseconds
 * @param {boolean} onlyTime If true, returns only the time for the specified date
 * @param {boolean} simplified If true, returns the date in a more human-friendly representation
 * @returns {string} The date made readable and represented in the default locale (Asia/Kolkata)
 */
export const formatDateToReadableString = (milliseconds?: string | number, onlyTime?: boolean, simplified?: boolean): string => {
 ...
 * @param payingUserData Data for the payin payload 
 * @param environment runtime environment. Used to construct the return_url; 
 * @returns 
 */
...
export const minEndDate = (startDate: string) => {
...
export function CountrySelect({ formFieldName, className, id, defaultValue }: { formFieldName: string, className: string, id: string, defaultValue: () => string }) {
    ...
    return (
        <select className={className} id={id} {...formMethods?.register(formFieldName)} defaultValue={defaultValue()}>
