...
import { ChatEvent, ContractEvent, NeutronEvent, PaymentEvent } from "~/models/events";
...
export function checkForSpecificEvent(events: NeutronEvent[], specifiedEvent: ContractEvent | ChatEvent | PaymentEvent) {

    return events.find((event) => event.event == specifiedEvent)
