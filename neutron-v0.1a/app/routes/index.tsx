    ...
    <div className="h-full w-full justify-center bg-bg-primary-dark align-middle">
      <div
        ...
        <img
          ...
          alt="hi there"
        ></img>
        {!parsedData.loggedIn ? <svg role="status" className="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg> : !parsedData.loggedIn ? <p className="prose prose-lg text-white p-6 transition-all">Not logged in </p> : <p className="prose prose-lg transition-all text-white p-6">Logged in ! Redirecting to dashboard...</p>}
