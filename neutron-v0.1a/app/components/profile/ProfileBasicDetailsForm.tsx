...
export default function ProfileBasicDetailsForm() {
    ...
    return (<form onSubmit={
        ...
        <div className="relative w-auto mt-2 mb-5 sm:mt-5 sm:mb-5 flex flex-col ">
            <span className=" prose prose-md text-white mb-5 text-[18px]">Display Name</span>
        ...
        <button
            className={`w-40 rounded-lg mt-2 self-start p-3 border-2 border-transparent ${primaryGradientDark} active:bg-amber-300 outline-none focus:ring-1 focus:ring-white focus:border-white hover:border-white hover:ring-white text-black font-gilroy-black font-[18px] transition-all`}
            type="submit"
        >
