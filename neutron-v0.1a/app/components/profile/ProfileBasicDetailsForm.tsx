...
export default function ProfileBasicDetailsForm() {
    ...
    return (<form onSubmit={
        ...
        <h2 className="prose prose-lg  text-white font-gilroy-black text-[30px]"> Basic Details </h2>
        <div className="relative w-auto mt-2  sm:mt-5 sm:mb-5 flex flex-col ">
            ...
            <div className="flex items-end mt-2 flex-col sm:space-y-3 sm:space-x-3 sm:flex-row w-full">
        ...
        <button
            className={`w-40 rounded-lg sm:mt-2 self-start p-3 border-2 border-transparent ${primaryGradientDark} active:bg-amber-300 outline-none focus:ring-1 focus:ring-white focus:border-white hover:border-white hover:ring-white text-black font-gilroy-black font-[18px] transition-all`}
            type="submit"
        >
