...
export default function ContractStats() {
    ...
    return (
        <motion.div className=" m-4 rounded-lg w-auto p-3 h-auto items-center">
            <motion.div className="border-solid border-2 flex flex-row border-white h-auto rounded-xl mt-10 text-left p-4 justify-between">
                <motion.div className=" flex flex-col">
                    ...
                    <motion.h1 className="prose prose-lg text-white"> 22</motion.h1>
                </motion.div>
            ...
            <motion.div className={`border-solid border-2 flex flex-row items-center  h-24 rounded-xl mt-4 text-left p-4 justify-between`}>
                <motion.div className=" flex flex-col">
                    ...
                    <motion.h1 className="prose prose-lg text-white text-left">5</motion.h1>
                </motion.div>
