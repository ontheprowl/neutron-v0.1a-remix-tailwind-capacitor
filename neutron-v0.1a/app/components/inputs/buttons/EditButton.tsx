...
export default function EditButton({ onClick, active }: { onClick?: React.MouseEventHandler<HTMLButtonElement>, active?: boolean }) {
    ...
    return (
        ...
        }} className="bg-primary-light font-gilroy-medium hover:opacity-70 transition-all min-w-fit text-sm rounded-lg p-3 text-primary-base space-x-2 flex flex-row items-center">
