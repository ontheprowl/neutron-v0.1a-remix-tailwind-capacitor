...
export default function DeleteButton({ onClick, text }: { onClick?: React.MouseEventHandler<HTMLButtonElement>, text?: string }) {
    ...
    }} className="bg-error-light hover:opacity-70  text-sm font-gilroy-medium transition-all rounded-lg p-3 min-w-fit text-error-dark space-x-2 flex flex-row items-center">
