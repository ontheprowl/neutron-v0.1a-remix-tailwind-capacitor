...
export default function SaveButton({ onClick, submit }: { onClick?: React.MouseEventHandler<HTMLButtonElement>, submit?: boolean }) {
    ...
    return (
        ...
        }} className="bg-success-light font-gilroy-medium text-sm hover:opacity-70 transition-all min-w-fit rounded-lg p-3 text-success-dark space-x-2 flex flex-row items-center">
