        ...
        <div className="flex flex-row justify-center">
            <div className="flex flex-row justify-center w-full items-center mt-2">
                <div className="flex flex-col justify-start space-y-2  p-6 w-full items-center text-center ">
                    ...
                    <h1 className="prose prose-lg font-gilroy-bold text-black text-base mt-5">Uh-oh! This field is looking empty!</h1>
                    <p className="prose prose-sm font-gilroy-regular text-black text-sm mb-5">You do not have any {entity} right now</p>
