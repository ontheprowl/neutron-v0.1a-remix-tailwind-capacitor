            ...
            <motion.div  className="flex flex-row space-x-3  items-center w-full justify-between">
                <div className="flex flex-row space-x-3 items-center w-4/6  justify-start">
                    ...
                    <div className="flex flex-col space-y-2">
                        <h1 className="font-gilroy-black text-lg">{event.payload?.message}hi</h1>
                        <span className="font-gilroy-medium text-md text-secondary-text">{new Date(event?.timestamp)?.toLocaleDateString('en-In')}</span>
                    </div>
                </div>
